...
function buildToDos(toDos) {
  // Tu código acá:
  var array = toDos.map(function(todo, index){ return buildToDo(todo, index)})
  return array;
}
...
function displayToDos() {
  ...
  // Paso 3
  var result = buildToDo(toDoItems);
  // Paso 4
...
function completeToDo(event) {
  ...
  // Paso 2
  displayToDos();
  // Paso 3 lo hacemos en buildToDo
